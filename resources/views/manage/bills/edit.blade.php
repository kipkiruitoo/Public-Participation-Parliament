        ...
        <div class="column is-three-quarters">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <form action="{{route('bill.update', $bill->id)}}" method="POST" role="form"
                        ...
                        <div class="field">
                            ...
                            <p class="control">
                                <input class="input" value="{{$bill->number}}" type="number" required name="number"
                                    id="number">
                            </p>
                        </div>
                        <!-- <p class="control">
                        ...
                        <div class="field">
                            <p class="control">
                                <textarea type="textarea" class="textarea" name="description" required
                                    ...
                                    rows="10">{{$bill->description}}</textarea>
                            </p>
                        </div>

                        <div class="file">
                            <label class=" file-label">
                                <input type="file" class="file-input" name="bill">
                                <span class="file-cta">
                        ...
                        <button type="submit"
                            class=" button is-success  is-fullwidth m-t-20 m-l-5 m-r-5 m-b-10">Edit</button>
